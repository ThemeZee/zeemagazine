...
function themezee_custom_jscript_navigation() { 
	...
	$params = array(
		'menuTitle' => __('Menu', 'zeeMagazine_language')
	);
...
function themezee_custom_jscript_posts() { 
	...
	// Set Parameters array
	$params = array(
		'loadMoreText' => __('Load More Posts', 'zeeMagazine_language'),
		'loadingText' => __('Loading posts...', 'zeeMagazine_language'),
		'noMoreText' => __('No more posts to load.', 'zeeMagazine_language'),
		'startPage' => $paged,
		'maxPages' => $max,
